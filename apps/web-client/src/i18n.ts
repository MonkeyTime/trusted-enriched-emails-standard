...
const dictionaries = {
  en: {
    ...
    inbox: "Inbox",
    inboxSubtitle: "IMAP + enriched messages",
    receive: "Receive",
    simulate: "Simulate",
    ...
    addTrustedDomain: "Add domain",
    addTrustedDomainPrompt: "Trusted domain or tree:// onboarding link",
    ...
    eventTrustedDomainAdded: "Trusted domain added: {domain} ({count} channels)",
    eventTrustedDomainFailed: "Trusted domain add failed: {domain} ({reason})",
    eventTrustedDomainInvalid: "Invalid trusted domain request: {value}",
    eventTrustedDomainLocalFallback: "Using local demo manifest fallback: {domain}",
    ...
    wellKnownProof: "Well-known HTTPS manifest",
    ...
    traditionalBody: "This message comes from a traditional mail account. It appears in the same inbox as enriched messages, but JavaScript remains disabled.",
  ...
  fr: {
    ...
    addTrustedDomain: "Ajouter domaine",
    addTrustedDomainPrompt: "Domaine trusted ou lien tree://",
    ...
    eventTrustedDomainAdded: "Domaine trusted ajoute: {domain} ({count} channels)",
    eventTrustedDomainFailed: "Ajout domaine trusted echoue: {domain} ({reason})",
    eventTrustedDomainInvalid: "Demande trusted domain invalide: {value}",
    eventTrustedDomainLocalFallback: "Fallback manifest local demo: {domain}",
    ...
    wellKnownProof: "Manifest HTTPS well-known",
